...
config_file.set("SMTPlogin", "sender_address", "sandbox.smtp.mailtrap.io")
config_file.set("SMTPlogin", "receiver_address", "465")
config_file.set("SMTPlogin", "mailtrap_user", "f5735a678bee8d")
config_file.set("SMTPlogin", "mailtrap_password", "0f50acb7842c12")
